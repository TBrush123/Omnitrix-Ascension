...
@onready var icon_rect: TextureRect = $MarginContainer/VBoxContainer/IconContainer/IconRect
...
func _hover(hovered: bool) -> void:
    ...
    tween.tween_property(self, "scale", Vector2(1.05, 1.05) if hovered else Vector2(1.0, 1.0), 0.08)
